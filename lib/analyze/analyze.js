...
function analyze(root, inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (inputs == null || inputs.length === 0) {
            ...
            return generate_elements_1.generateElementMetadata(_package, '', isNotTest);
        }
        else {
            const documents = yield Promise.all(inputs.map((i) => analyzer.analyze(i)));
            return generate_elements_1.generateElementMetadata(documents, '', isNotTest);
        }
    });
}
